...
if menu == "FORMULIR KUNJUNGAN PUBLIK":
    ...
    with tab1:
        if not st.session_state.tamu_terdaftar:
            ...
            with st.container(border=True):
                ...
                with col4:
                    # FIX: Selalu tampilkan input, tapi di-disable jika bukan 'Lain-lain' untuk mencegah layout shift
    ...
    with tab2:
        ...
        with st.form("form_permohonan_data"):
            ...
            # Info box diletakkan di luar kolom agar tidak merusak tinggi kolom
            ...
            # FIX: Semua uploader selalu ditampilkan, tapi otomatis dikunci (disabled) sesuai kategorinya
            with col_u1:
