            ...
            if not st.session_state.tamu_terdaftar:
                ...
                with st.container(border=True):
                    ...
                    with col4:
                        alasan_lainnya = ""
                        if tujuan == "Lain-lain":
                            alasan_lainnya = st.text_input("URAIKAN MAKSUD KUNJUNGAN SECARA SPESIFIK:", placeholder="Tuliskan Keperluan Anda", key="alasan_tamu")
                        else:
                            st.empty() # Mencegah bug Streamlit pada kolom kosong
